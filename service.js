...
var genapp3 = angular.module('genapp3');
genapp3.service('Util', function($filter) {
...
genapp3.service('BSServiceUtil', function(notify, ExportService, BSService, Cache) {
...
genapp3.service('EmailService', function(notify, BSService) {
...
genapp3.service('CommentService', function(notify, BSService) {
...
genapp3.factory('ExportService', function($resource) {
...
genapp3.factory('BSService', function($resource) {
...
genapp3.service('AlertService', function(SweetAlert,notify) {
...
genapp3.service('AppService', function(notify, BSServiceUtil, AlertService, Cache) {
...
genapp3.service('Cache', function() {
    var map;
